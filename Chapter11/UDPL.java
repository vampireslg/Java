...
class L_Frame extends Frame implements Runnable,ActionListener{
    TextField out_message = new TextField("Send Message to K : ");
    TextArea in_message = new TextArea();
    Button b = new Button("Send Msg Package to K");
    L_Frame(){
	super("L");
...
public class UDPL{
	...
	L_Frame l_win = new L_Frame();
	l_win.addWindowListener(new WindowAdapter(){
